...
{
    public partial class CafeMsetcoupons : Form
    {
        public CafeMsetcoupons()
        {
            InitializeComponent();
            populateData();
        }
        ...
        public void populateData()
        {
            ...
            string query = "select code, descrpt, disc_amt from Coupon";
            ...
            if (rdr.HasRows)
            {
                ...
                dataGridView1.Columns.Add("Dicount%", "Discount%");
                ...
                while (rdr.Read())
                {
                    ...
                    string dis = rdr["disc_amt"].ToString();

                    dataGridView1.Rows.Add(code, des, dis);
                }
            }
        ...
        {
            CafeMsetcouponsto c = new CafeMsetcouponsto();
            c.Visible = true;
            this.Visible = false;
        }
    }

...
{
    public partial class Custmenudrinks : Form
    {
        public Custmenudrinks()
        {
            InitializeComponent();
            populateData();
        }
        ...
        public void populateData()
        {
            ...
            string query = "select id,name,descrpt,nut_info,price from MenuItems group by category,id,name,descrpt,nut_info,price having category='Drinks'";

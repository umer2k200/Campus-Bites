...
{
    public partial class Custmenusnacks : Form
    {
        public Custmenusnacks()
        {
            InitializeComponent();
            populateData();
        }
        ...
        public void populateData()
        {
            ...
            string query = "select id,name,descrpt,nut_info,price from MenuItems group by category,id,name,descrpt,nut_info,price having category='Snacks'";
